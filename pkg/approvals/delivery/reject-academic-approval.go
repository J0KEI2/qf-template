...
func (h *programApprovalHandler) RejectAcademicApprovalByProgramUID() fiber.Handler {
	return func(c *fiber.Ctx) (err error) {
		...
		approval, err := h.ApprovalUseCase.RejectAcademicApprovalByProgramUID(&programUID, request)
		if err != nil {
			responseForm.Success = false
			responseForm.Errors = append(responseForm.Errors, helpers.ResponseError{
				Code:    fiber.StatusInternalServerError,
