...
func (h *programApprovalHandler) ApproveUniversityApprovalByProgramUID() fiber.Handler {
	return func(c *fiber.Ctx) (err error) {
		...
		approval, err := h.ApprovalUseCase.ApproveUniversityApprovalByProgramUID(&programUID, request)
		if err != nil {
			responseForm.Success = false
			responseForm.Errors = append(responseForm.Errors, helpers.ResponseError{
				Code:    fiber.StatusInternalServerError,
