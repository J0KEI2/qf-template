...
func (h *programApprovalHandler) SelectCurriculumCommittees() fiber.Handler {
	return func(c *fiber.Ctx) (err error) {
		...
		var request dto.SelectCurriculumCommittees
		...
		approval, err := h.ApprovalUseCase.SelectCurriculumCommittees(&programUID, request.CommitteeUserIDs)
		if err != nil {
			responseForm.Success = false
			responseForm.Errors = append(responseForm.Errors, helpers.ResponseError{
