...
func (h *programApprovalHandler) ApproveFacultyApprovalByProgramUID() fiber.Handler {
	return func(c *fiber.Ctx) (err error) {
		...
		var request dto.ApproveApprovalRequestDto
		...
		approval, err := h.ApprovalUseCase.ApproveFacultyApprovalByProgramUID(&programUID, request)
		if err != nil {
			responseForm.Success = false
			responseForm.Errors = append(responseForm.Errors, helpers.ResponseError{
				Code:    fiber.StatusInternalServerError,
