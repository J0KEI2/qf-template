...
func (h *programApprovalHandler) GetAllApproval() fiber.Handler {
	return func(c *fiber.Ctx) (err error) {
		...
		// Call Get all approvals
		approvals, err := h.ApprovalUseCase.GetAllApproval(&programUID)
		if err != nil {
			responseForm.Success = false
			responseForm.Errors = append(responseForm.Errors, helpers.ResponseError{
