...
func (h *programApprovalHandler) RejectCurriculumCommitteeResult() fiber.Handler {
	return func(c *fiber.Ctx) (err error) {
		...
		var request dto.RejectApprovalCommitteeResultRequestDto
		...
		approval, err := h.ApprovalUseCase.RejectCurriculumCommitteeResult(&programUID, request)
		if err != nil {
			responseForm.Success = false
			responseForm.Errors = append(responseForm.Errors, helpers.ResponseError{
				Code:    fiber.StatusInternalServerError,
