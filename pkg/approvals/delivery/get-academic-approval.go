...
func (h *programApprovalHandler) GetAcademicApprovalByProgramUID() fiber.Handler {
	return func(c *fiber.Ctx) (err error) {
		...
		approval, err := h.ApprovalUseCase.GetAcademicApprovalByProgramUID(&programUID, *userApprovalLevel)
		if err != nil {
			responseForm.Success = false
			responseForm.Errors = append(responseForm.Errors, helpers.ResponseError{
