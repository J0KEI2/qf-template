...
func (h *programApprovalHandler) ApproveCurriculumCommitteeResult() fiber.Handler {
	return func(c *fiber.Ctx) (err error) {
		...
		var request dto.ApproveApprovalCommitteeResultRequestDto
		...
		approval, err := h.ApprovalUseCase.ApproveCurriculumCommitteeResult(&programUID, request)
		if err != nil {
			responseForm.Success = false
			responseForm.Errors = append(responseForm.Errors, helpers.ResponseError{
				Code:    fiber.StatusInternalServerError,
