...
func (h programHandler) CreateOrUpdatePlo() fiber.Handler {
	return func(c *fiber.Ctx) (err error) {
		...
		request := dto.CreateOrUpdatePLORequestDto{}
		...
		err = h.programUseCase.CreateOrUpdatePlo(request, uint(subPlanID))
