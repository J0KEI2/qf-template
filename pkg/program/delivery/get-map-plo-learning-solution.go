...
func (h programHandler) GetMapPloLearningSolution() fiber.Handler {
	return func(c *fiber.Ctx) (err error) {
		...
		respModel, err := h.programUseCase.GetMapPloWithLearningSolution(uint(ploID), &paginationOptions)
		if err != nil {
			responseForm.Success = false
			responseForm.Errors = append(responseForm.Errors, helpers.ResponseError{
